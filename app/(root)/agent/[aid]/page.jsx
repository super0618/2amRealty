      ...
      <div className="container grid grid-cols-3 gap-6">
        <div className="col-span-3 md:col-span-2 space-y-6">
          <div className="bg-white rounded-md border shadow-sm p-6">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="col-span-2">
                <Link
                  href="/agent/sfsef"
                  className="font-bold text-[#666x] block cursor-pointer mb-1 hover:text-[#B63437]"
                >
                  Renovated Apart
                </Link>
          ...
          <div className="bg-white rounded-md shadow-sm border p-6">
            ...
            <div className="space-y-4">
              ...
              <input
                type="text"
                className="border rounded-lg w-full py-1 px-4"
                placeholder="Review Title"
              />
              <textarea
                className="border rounded-lg py-3 px-4 w-full h-36"
        ...
        <div className="hidden md:block space-y-6">
          <div className="bg-white p-6 rounded-md shadow-sm border">
            ...
            <input
              type="text"
              className="px-4 py-1 border border-gray-300 rounded-md mb-4 w-full"
            ...
            />
            <textarea
              className="px-4 py-2 border border-gray-300 rounded-md mb-4 w-full h-36 resize-none"
              placeholder="Your Message"
            ></textarea>
            <div className="bg-[#B63437] py-2 text-center text-white rounded-lg w-full cursor-pointer hover:bg-[#e94c51]">
              Search
            </div>
          </div>
