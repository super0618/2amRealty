		...
		<div className="pt-32 pb-12 bg-gray-50">
			<div className="container mb-4">
				<div className="flex justify-between items-center mb-4">
					<h2 className="font-bold text-2xl text-[#333]">Agent</h2>
				</div>
			</div>
			<div className="container grid grid-cols-3 gap-6">
				<div className="col-span-3 md:col-span-2 space-y-6">
					<div className="bg-white rounded-md shadow-sm p-6">
						<div className="grid grid-cols-3 gap-4">
							<div>
								<img src="/assets/images/agents/1.jpg" alt="agent" className="h-full object-cover rounded-lg" />
							</div>
							<div className="col-span-2">
								...
								<div className="flex gap-2 py-2">
									<Facebook size={16} color="#999" fill="#999" />
									<Twitter size={16} color="#999" fill="#999" />
									<Instagram size={16} color="#999" />
									<Dribbble size={16} color="#999" />
									<Linkedin size={16} color="#999" />
								</div>
							</div>
						</div>
					</div>
					...
					<div className="bg-white p-6 rounded-md shadow-sm border">
						<div className="text-xl font-bold text-[#333] mb-6">Listing</div>
						<AgentListing
				...
				<div className="hidden md:block space-y-6">
					<div className="bg-white p-6 rounded-md shadow-sm border">
						<h2 className="text-lg font-bold text-[#333] mb-4">Contact with Agent</h2>
