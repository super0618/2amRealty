			...
			<div className="container grid grid-cols-3 gap-6">
				<div className="col-span-3 md:col-span-2 space-y-6">
					<div className="bg-white px-6 py-12 border rounded-md shadow-sm">
						...
						<div className="mb-4">
							<img src="/images/blog/thumb1.jpg" alt="thumb" className="w-full rounded-md" />
						</div>
						<div className="space-y-4 mb-4">
							...
							<p className="font-bold text-lg">Housing Markets That Changed the Most This Decade</p>
							<p>
								...
								Curabitur adipiscing erat vel libero tempus congue. Nam pharetra interdum vestibulum. Aenean gravida mi non aliquet porttitor.
								Praesent dapibus, nisi a faucibus tincidunt, quam dolor condimentum metus, in convallis libero ligula ut eros.
							</p>
							<p>
					...
					<div className="flex justify-between gap-4">
						<Blog thumb="/images/blogs/thumb1.jpg" avatar="/images/blogs/user1.png" username="Ali Tufan" title="Luxury Family Home" minimized />
						<Blog thumb="/images/blogs/thumb2.jpg" avatar="/images/blogs/user2.png" username="Ali Tufan" title="Luxury Family Home" minimized />
					</div>
				</div>
				<div className="hidden md:block space-y-6">
					<div className="bg-white p-6 rounded-md border shadow-sm">
						<input className="border rounded-md w-full py-1 px-4" placeholder="Search Here" />
					</div>
					...
					<div className="bg-white p-6 rounded-md shadow-sm border">
						...
						<div className="flex flex-wrap text-xs gap-2">
							...
							<div className="py-2 px-4 bg-gray-100 rounded-md cursor-pointer hover:bg-gray-200">Estate</div>
							<div className="py-2 px-4 bg-gray-100 rounded-md cursor-pointer hover:bg-gray-200">Luxury</div>
							<div className="py-2 px-4 bg-gray-100 rounded-md cursor-pointer hover:bg-gray-200">Real</div>
						</div>
					</div>
				</div>
			</div>
