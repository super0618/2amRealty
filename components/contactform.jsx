			...
			<div className="container grid grid-cols-3 py-12 gap-6">
				<div className="col-span-2 bg-white p-6 rounded-md shadow-sm">
					...
					<p className="mb-4">
						...
						sit amet blandit nisl iaculis. Donec lacus odio, malesuada eu libero sit amet, congue aliquam leo. In hac habitasse platea dictumst.
					</p>
				...
				<div className="bg-white p-6 rounded-md shadow-sm">
					...
					<div className="flex gap-2 mb-6">
						<div className="grid w-8 h-8 place-items-center bg-gray-50 rounded-md cursor-pointer">
