export default function () {
	return (
		<div className="bg-[url('/assets/images/bg.jpg')] relative object-cover bg-center h-[960px] grid place-items-center text-white before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:bg-[#1d293e] before:opacity-60">
