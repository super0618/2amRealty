export default function () {
	return (
		<div className="container py-16">
			<div className="text-4xl font-bold mb-2 text-center">Our Mission Is To FindHouse</div>
			...
			<div className="grid grid-cols-3 md:grid-cols-5 gap-12">
				...
				<div className="hidden md:block md:col-span-2 bg-[url('/images/about/thumb.jpg')] bg-center bg-cover shrink-0 bg-no-repeat rounded-2xl overflow-hidden shadow-md"></div>
			</div>
		</div>
	);
}
